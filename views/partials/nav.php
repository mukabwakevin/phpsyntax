                    ...
                    <div class="relative ml-3">
                        <div>
                            ...
                            <button type="button"
                                ...
                                <?php else : ?>
                                    <a href="/register"
                                       class="<?= urlIs('/register') ? ' text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Register</a>
                                    <a href="/login"
                                       class="<?= urlIs('/login') ? ' text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Log In</a>
                                <?php endif; ?>
                            </button>
                        </div>
                    </div>
